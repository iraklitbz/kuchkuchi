  ...
  <div class="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-20">
    <div class="w-full max-w-md">
      ...
      <div class="mb-8 text-center">
        ...
        <h1 class="font-display text-2xl font-bold text-zinc-900">კეთილი დაბრუნება</h1>
        <p class="mt-2 text-sm text-zinc-500">შედით თქვენს ანგარიშში</p>
      </div>
      ...
      <form class="space-y-4" @submit.prevent="handleLogin">
        ...
        <div>
          <div class="mb-1.5 flex items-center justify-between">
            <label class="text-sm font-medium text-zinc-700">პაროლი</label>
            <NuxtLink to="/forgot-password" class="text-xs text-brand hover:underline">
              პაროლი დაგავიწყდათ?
            </NuxtLink>
          </div>
          <input
      ...
      <p class="mt-6 text-center text-sm text-zinc-500">
        ანგარიში არ გაქვთ?
        <NuxtLink to="/register" class="font-medium text-brand hover:underline">
          შექმენით
        </NuxtLink>
      </p>
    </div>
